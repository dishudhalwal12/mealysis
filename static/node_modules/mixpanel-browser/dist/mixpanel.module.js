...
function extractFileExtension(path, baseURL) {
  ...
  try {
    url = new URL(
      path,
      baseURL !== null && baseURL !== void 0 ? baseURL : window.location.href
    );
  } catch (err) {
    return null;
  }
  ...
  return (_a = match === null || match === void 0 ? void 0 : match[1]) !==
    null && _a !== void 0
    ? _a
    : null;
}
  ...
  return {
    left: doc.scrollingElement
      ...
      : (doc === null || doc === void 0
        ...
        ((_b =
          (_a = doc === null || doc === void 0 ? void 0 : doc.body) === null ||
          _a === void 0
            ? void 0
            : _a.parentElement) === null || _b === void 0
          ? void 0
          : _b.scrollLeft) ||
        ((_c = doc === null || doc === void 0 ? void 0 : doc.body) === null ||
        _c === void 0
          ? void 0
          : _c.scrollLeft) ||
        0,
    top: doc.scrollingElement
      ...
      : (doc === null || doc === void 0
        ...
        ((_e =
          (_d = doc === null || doc === void 0 ? void 0 : doc.body) === null ||
          _d === void 0
            ? void 0
            : _d.parentElement) === null || _e === void 0
          ? void 0
          : _e.scrollTop) ||
        ((_f = doc === null || doc === void 0 ? void 0 : doc.body) === null ||
        _f === void 0
          ? void 0
          : _f.scrollTop) ||
        0,
...
class StyleSheetMirror {
  ...
  getId(stylesheet) {
    var _a;
    return (_a = this.styleIDMap.get(stylesheet)) !== null && _a !== void 0
      ? _a
      : -1;
  }
  has(stylesheet) {
...
function getShadowHost(n) {
  ...
  if (
    ((_b =
      (_a = n.getRootNode) === null || _a === void 0 ? void 0 : _a.call(n)) ===
      null || _b === void 0
      ? void 0
...
function initAdoptedStyleSheetObserver({ mirror, stylesheetManager }, host) {
  ...
  const patchTarget =
    host.nodeName === "#document"
      ? (_a = host.defaultView) === null || _a === void 0
        ...
        : _a.Document
      : (_c =
          (_b = host.ownerDocument) === null || _b === void 0
            ? void 0
            : _b.defaultView) === null || _c === void 0
      ? void 0
      : _c.ShadowRoot;
  const originalPropertyDescriptor = (
    patchTarget === null || patchTarget === void 0
      ? void 0
  ...
  Object.defineProperty(host, "adoptedStyleSheets", {
    ...
    get() {
      var _a;
      return (_a = originalPropertyDescriptor.get) === null || _a === void 0
        ? void 0
        : _a.call(this);
    },
    set(sheets) {
      var _a;
      const result =
        (_a = originalPropertyDescriptor.set) === null || _a === void 0
          ? void 0
          : _a.call(this, sheets);
...
function initObservers(o, hooks = {}) {
  ...
  return callbackWrapper(() => {
    ...
    mutationObserver === null || mutationObserver === void 0
      ? void 0
            ...
            if (
              ((_a =
                context === null || context === void 0
                  ? void 0
                  : context.getContextAttributes()) === null || _a === void 0
                ? void 0
          ...
          plugins:
            ((_a =
              plugins === null || plugins === void 0
                ? void 0
                : plugins.filter((p) => p.observer)) === null || _a === void 0
              ? void 0
              : _a.map((p) => ({
                  observer: p.observer,
                  options: p.options,
...
function isUserEvent(ev) {
  return (
    ...
    ACTIVE_SOURCES.has(ev.data.source)
  );
}
...
SessionRecording.prototype.startRecording = function (shouldStopBatcher) {
  ...
  if (this.recordMaxMs > MAX_RECORDING_MS) {
    this.recordMaxMs = MAX_RECORDING_MS;
    logger$2.critical(
      "record_max_ms cannot be greater than " +
        MAX_RECORDING_MS +
        "ms. Capping value."
    );
  }
  ...
  if (this.recordMinMs > MAX_VALUE_FOR_MIN_RECORDING_MS) {
    ...
    logger$2.critical(
      "record_min_ms cannot be greater than " +
  ...
  var resetIdleTimeout = _.bind(function () {
    ...
    this.idleTimeoutId = setTimeout(
      this._onIdleTimeout,
      this.getConfig("record_idle_timeout_ms")
    );
  }, this);
    ...
    emit: _.bind(function (ev) {
      ...
      if (isUserEvent(ev)) {
        if (
          ...
          new Date().getTime() - this.replayStartTime >= this.recordMinMs
        ) {
  ...
  this.maxTimeoutId = setTimeout(
    _.bind(this._onMaxLengthReached, this),
    this.recordMaxMs
  );
};
 ...
 */
SessionRecording.prototype.flushEventsWithOptOut = function (
  data,
  options,
  cb
) {
...
SessionRecording.prototype._sendRequest = function (
  currentReplayId,
  reqParams,
  reqBody,
  callback
...
SessionRecording.prototype._flushEvents = addOptOutCheckMixpanelLib(function (
  data,
  options,
  callback
) {
  ...
  if (numEvents > 0) {
    ...
    if (CompressionStream) {
      ...
      new Response(gzipStream).blob().then(
        _.bind(function (compressedBlob) {
...
Autocapture.prototype.initClickTracking = function () {
  ...
  this.listenerClick = win.addEventListener(
    EV_CLICK,
    function (ev) {
      if (!this.getConfig(CONFIG_TRACK_CLICK)) {
        return;
...
Autocapture.prototype.initInputTracking = function () {
  ...
  this.listenerChange = win.addEventListener(
    EV_CHANGE,
    function (ev) {
      if (!this.getConfig(CONFIG_TRACK_INPUT)) {
        return;
...
Autocapture.prototype.initPageviewTracking = function () {
  ...
  this.listenerLocationchange = win.addEventListener(
...
Autocapture.prototype.initScrollTracking = function () {
  ...
  this.listenerScroll = win.addEventListener(
    EV_SCROLLEND,
    safewrap(
      function () {
        if (!this.getConfig(CONFIG_TRACK_SCROLL)) {
        ...
        var scrollCheckpoints = (
          this.getConfig(CONFIG_SCROLL_CHECKPOINTS) || []
        )
          .slice()
          .sort(function (a, b) {
            return a - b;
...
Autocapture.prototype.initSubmitTracking = function () {
  ...
  this.listenerSubmit = win.addEventListener(
    EV_SUBMIT,
    function (ev) {
      if (!this.getConfig(CONFIG_TRACK_SUBMIT)) {
        return;
...
MixpanelLib.prototype.start_session_recording = addOptOutCheckMixpanelLib(
  function () {
