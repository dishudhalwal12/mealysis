  ...
  _createClass(DomHandler, null, [
        ...
        if (element) {
          var computedStyles = function computedStyles(rule, value) {
            ...
            var styles =
              element !== null &&
              element !== void 0 &&
              (_element$$attrs = element.$attrs) !== null &&
              _element$$attrs !== void 0 &&
              _element$$attrs[rule]
                ? [
                    element === null ||
                    element === void 0 ||
                    (_element$$attrs2 = element.$attrs) === null ||
                    _element$$attrs2 === void 0
                      ? void 0
                      : _element$$attrs2[rule],
                  ]
                : [];
              ...
              if (v !== null && v !== undefined) {
                ...
                if (type === "string" || type === "number") {
                  ...
                  var _cv = Array.isArray(v)
                    ...
                    : Object.entries(v).map(function (_ref3) {
                        var _ref4 = _slicedToArray(_ref3, 2),
                          _k = _ref4[0],
                          _v = _ref4[1];
                        return rule === "style" && (!!_v || _v === 0)
                          ? ""
                              .concat(
                                _k
                ...
                (position.my.x === "left"
                  ...
                  : -1 *
                    (position.my.x === "center"
                      ? _this2.getOuterWidth(element) / 2
                      : _this2.getOuterWidth(element)))
              );
            },
            top: function top() {
                ...
                (position.my.y === "top"
                  ...
                  : -1 *
                    (position.my.y === "center"
                      ? _this2.getOuterHeight(element) / 2
                      : _this2.getOuterHeight(element)))
              );
            },
          };
          var alignWithAt = {
            ...
            center: function center(axis) {
              if (axis === "y") {
                var top =
                  myOffset.top() + DomHandler.getOuterHeight(target) / 2;
                element.style.top =
                ...
                var left =
                  myOffset.left() + DomHandler.getOuterWidth(target) / 2;
                element.style.left =
    ...
    },
    {
      ...
      value: function getScrollableParents(element) {
        var hideOverlaysOnDocumentScrolling =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : false;
          ...
          var overflowCheck = function overflowCheck(node) {
            ...
            return (
              ...
              (overflowRegex.test(
                ...
                overflowRegex.test(
                  styleDeclaration.getPropertyValue("overflow-x")
                ) ||
                overflowRegex.test(
                  styleDeclaration.getPropertyValue("overflow-y")
                ))
            );
          };
        ...
        if (
          !scrollableParents.some(function (node) {
    ...
    },
    {
      ...
      value: function scrollInView(container, item) {
        var borderTopValue =
          getComputedStyle(container).getPropertyValue("border-top-width");
      ...
      value: function getFocusableElements(element) {
        var selector =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : "";
        var focusableElements = DomHandler.find(
          element,
    ...
    },
    {
      ...
      value: function getFirstFocusableElement(element, selector) {
        var focusableElements = DomHandler.getFocusableElements(
          element,
          selector
        );
    ...
    },
    {
      ...
      value: function focusFirstElement(el, scrollTo) {
        ...
        firstFocusableElement &&
          DomHandler.focus(firstFocusableElement, scrollTo);
      ...
      value: function isEqualElement(elm1, elm2) {
        ...
        for (var index = 0; index < attrs1.length; ++index) {
          ...
          if (name === "style") {
            ...
            var rexDigitsOnly = /^\d+$/;
            for (
              var _i3 = 0, _Object$keys = Object.keys(astyle);
    ...
    },
    {
      ...
      value: function hasCSSTransition(element) {
        if (element) {
          var style = getComputedStyle(element);
          var transitionDuration = parseFloat(
  ...
  _createClass(ObjectUtils, null, [
    ...
    },
    {
      ...
      value: function getPropCaseInsensitive(props, prop) {
        ...
        for (var _key3 in defaultProps) {
          if (
            defaultProps.hasOwnProperty(_key3) &&
            this.toFlatCase(_key3) === fkey
          ) {
      ...
      value: function isValidChild(child, type, validTypes) {
        ...
        if (child) {
          ...
          if (
            ...
            _child$type !== void 0 &&
            (_child$type = _child$type._payload) !== null &&
            _child$type !== void 0 &&
            _child$type.value
          ) {
    ...
    },
    {
      ...
      value: function isDate(value) {
        return (
          value !== null && value instanceof Date && value.constructor === Date
        );
      },
    },
    {
      ...
      value: function isPrintableCharacter() {
        var _char =
          arguments.length > 0 && arguments[0] !== undefined
            ...
            : "";
        return (
          this.isNotEmpty(_char) && _char.length === 1 && _char.match(/\S| /)
        );
      },
    },
    {
        ...
        if (this.isNotEmpty(arr)) {
          try {
            ...
            index = arr.lastIndexOf(
              _toConsumableArray(arr).reverse().find(callback)
            );
          }
        }
        return index;
...
function handler() {
  ...
  var generateZIndex = function generateZIndex(key, autoZIndex) {
    var baseZIndex =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 999;
