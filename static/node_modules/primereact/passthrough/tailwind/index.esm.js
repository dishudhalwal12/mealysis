    ...
    meterLabel: function meterLabel(_ref54) {
      ...
      return {
        className: classNames(
          ...
          {
            "bg-red-500":
              ((_state$meter = state.meter) === null || _state$meter === void 0
                ? void 0
                : _state$meter.strength) == "weak",
            "bg-orange-500":
              ((_state$meter2 = state.meter) === null ||
              _state$meter2 === void 0
                ? void 0
                : _state$meter2.strength) == "medium",
            "bg-green-500":
              ((_state$meter3 = state.meter) === null ||
              _state$meter3 === void 0
                ? void 0
                : _state$meter3.strength) == "strong",
          },
          {
          ...
          className: classNames(
            ...
            "hover:border-blue-500 focus:outline-none focus:outline-offset-0 focus:shadow-[0_0_0_0.2rem_rgba(191,219,254,1)] dark:focus:shadow-[0_0_0_0.2rem_rgba(147,197,253,0.5)]",
            {
              "border-gray-300 dark:border-blue-900/40 bg-white dark:bg-gray-900":
                !(props !== null && props !== void 0 && props.checked),
    ...
    checkbox: function checkbox(_ref77) {
      ...
      return {
        className: classNames(
          ...
          {
            "border-gray-300 dark:border-blue-900/40  bg-white dark:bg-gray-900":
              !(context !== null && context !== void 0 && context.selected),
            "border-blue-500 bg-blue-500":
              context === null || context === void 0
                ? void 0
                : context.selected,
      ...
      return {
        className: classNames(
          ...
          "absolute py-1 bg-white dark:bg-gray-900 border-0 shadow-md w-full",
          {
            ...
            "flex ":
              state === null || state === void 0 ? void 0 : state.mobileActive,
          }
        ),
      };
    },
        ...
        className: classNames(
          ...
          "bg-white dark:bg-gray-900 text-gray-700 dark:text-white/80 p-5",
          {
            "border border-solid border-gray-300 dark:border-blue-900/40 rounded-md":
              ((_props$__parentMetada = props.__parentMetadata) === null ||
              _props$__parentMetada === void 0
                ? void 0
                : _props$__parentMetada.parent.props.__TYPE) !== "TreeSelect",
          }
        ),
      };
    },
    ...
    item: function item(_ref144) {
      ...
      return {
        className: classNames(
          ...
          "transition duration-200",
          {
            "text-blue-700 bg-blue-500/20 dark:bg-blue-300/20":
              context.selected,
          }
        ),
      };
        ...
        return {
          className: classNames(
            ...
            context.sorted
              ...
              : "dark:text-white/80 dark:bg-gray-900",
            // Dark Mode
            {
