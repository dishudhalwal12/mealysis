...
var FilterService = {
  ...
  filters: {
    startsWith: function startsWith(value, filter, filterLocale) {
      ...
      var filterValue = ObjectUtils.removeAccents(
        filter.toString()
      ).toLocaleLowerCase(filterLocale);
      var stringValue = ObjectUtils.removeAccents(
        value.toString()
      ).toLocaleLowerCase(filterLocale);
...
_defineProperty(
  PrimeReact$1,
  "changeTheme",
  function (currentTheme, newTheme, linkElementId, callback) {
    ...
    (_linkElement$parentNo = linkElement.parentNode) === null ||
      _linkElement$parentNo === void 0 ||
      _linkElement$parentNo.insertBefore(
        cloneLinkElement,
...
function localeOption(key, locale) {
  ...
  try {
    ...
    throw new Error(
      "The "
        .concat(key, " option is not found in the current locale('")
        .concat(_locale, "').")
    );
  }
}
...
function ariaLabel(ariaKey, options) {
  ...
  try {
    ...
    throw new Error(
      "The "
        .concat(ariaKey, " option is not found in the current locale('")
        .concat(_locale, "').")
    );
  }
}
...
var PrimeReactProvider = function PrimeReactProvider(props) {
  ...
  var _useState15 = useState(
      propsValue.hideOverlaysOnDocumentScrolling || false
    ),
